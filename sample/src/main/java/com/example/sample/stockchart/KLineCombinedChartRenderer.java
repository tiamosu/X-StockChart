 ...
 * @date 2019/1/15.
 */
public class KLineCombinedChartRenderer extends CombinedChartRenderer {

    public KLineCombinedChartRenderer(CombinedChart chart, ChartAnimator animator, ViewPortHandler viewPortHandler) {
            ...
            switch (order) {
                case BAR:
                    if (chart.getBarData() != null) {
                        mRenderers.add(new KLineBarChartRenderer(chart, mAnimator, mViewPortHandler));
                    }
                    break;
                case BUBBLE:
