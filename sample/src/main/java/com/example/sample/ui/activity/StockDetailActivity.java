...
public class StockDetailActivity extends BaseActivity {
    ...
    protected void onLoadData() {
        ...
        final Fragment[] fragments = {
            TimeSharingFragment.newInstance(false),
            TimeSharingFragment.newInstance(true),
            ChartKLineFragment.newInstance(1),
            ChartKLineFragment.newInstance(7),
            ChartKLineFragment.newInstance(30)
        };
        final String[] titles = {
