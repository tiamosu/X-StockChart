...
public class ScatterChartRenderer extends LineScatterCandleRadarRenderer {
    ...
    public void drawData(Canvas c) {
        final ScatterData scatterData = mChart.getScatterData();
    ...
    protected void drawDataSet(Canvas c, IScatterDataSet dataSet) {
        ...
        final ViewPortHandler viewPortHandler = mViewPortHandler;
        final Transformer trans = mChart.getTransformer(dataSet.getAxisDependency());
        final float phaseY = mAnimator.getPhaseY();
        final IShapeRenderer renderer = dataSet.getShapeRenderer();
        if (renderer == null) {
            Log.i("MISSING", "There's no IShapeRenderer specified for ScatterDataSet");
            return;
        }

        final int max = (int) (Math.min(
    ...
    public void drawHighlighted(Canvas c, Highlight[] indices) {
        ...
        for (Highlight high : indices) {
            final IScatterDataSet set = scatterData.getDataSetByIndex(high.getDataSetIndex());
