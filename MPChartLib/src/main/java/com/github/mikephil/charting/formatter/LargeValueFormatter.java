...
public class LargeValueFormatter extends ValueFormatter {
    ...
    private String makePretty(double number) {
        ...
        final int numericValue1 = Character.getNumericValue(r.charAt(r.length() - 1));
        final int numericValue2 = Character.getNumericValue(r.charAt(r.length() - 2));
        final int combined = Integer.valueOf(numericValue2 + "" + numericValue1);
