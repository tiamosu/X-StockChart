...
public class ChartAnimator {
    ...
    private ObjectAnimator xAnimator(int duration, EasingFunction easing) {
        final ObjectAnimator animatorX = ObjectAnimator.ofFloat(this, "phaseX", 0f, 1f);
    ...
    private ObjectAnimator yAnimator(int duration, EasingFunction easing) {
        final ObjectAnimator animatorY = ObjectAnimator.ofFloat(this, "phaseY", 0f, 1f);
    ...
    public void animateX(int durationMillis, EasingFunction easing) {
        final ObjectAnimator animatorX = xAnimator(durationMillis, easing);
    ...
    public void animateXY(int durationMillisX, int durationMillisY, EasingFunction easing) {
        final ObjectAnimator xAnimator = xAnimator(durationMillisX, easing);
        final ObjectAnimator yAnimator = yAnimator(durationMillisY, easing);
    ...
    public void animateXY(int durationMillisX, int durationMillisY,
        ...
        final ObjectAnimator xAnimator = xAnimator(durationMillisX, easingX);
        final ObjectAnimator yAnimator = yAnimator(durationMillisY, easingY);
    ...
    public void animateY(int durationMillis, EasingFunction easing) {
        final ObjectAnimator animatorY = yAnimator(durationMillis, easing);
