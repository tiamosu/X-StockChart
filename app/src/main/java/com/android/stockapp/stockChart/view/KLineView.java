...
import com.android.stockapp.stockChart.CandleCombinedChart;
import com.android.stockapp.stockChart.CoupleChartGestureListener;
import com.android.stockapp.stockChart.KRightMarkerView;
import com.android.stockapp.stockChart.LeftMarkerView;
import com.android.stockapp.stockChart.MyCombinedChart;
...
public class KLineView extends BaseView {
    ...
    private void chartSwitch(int index) {
        switch (chartType1) {
            case 1:
                barChart.setDescriptionCustom(ContextCompat.getColor(mContext, R.color.label_text), getResources().getString(R.string.vol_name) + formatVol(mContext, kLineData.getAssetId(), kLineData.getKLineDatas().get(index).getVolume()));
                break;
            case 2:
